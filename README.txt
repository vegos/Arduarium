...
You can enable manually the fan, by pressing the star (*) key. Pressing it again will
stop the fan.
...
absolute values (e.g. 29.9 is not equal to 30, but 30.1 and 30.9 is equal to
30).
